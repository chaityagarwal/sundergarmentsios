// ignore_for_file: file_names, prefer_const_constructors, sized_box_for_whitespace, avoid_unnecessary_containers, prefer_interpolation_to_compose_strings
      ...
      body: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (snapshot.data!.docs.isEmpty) {
            return Center(
              child: Text("Stay Tuned!! Sale COMING SOON...."),
            );
          }
